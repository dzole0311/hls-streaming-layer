...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: 'react-map-gl/mapbox',   replacement: path.resolve(__dirname, '../node_modules/react-map-gl/dist/esm/exports-mapbox.js') },
      { find: 'react-map-gl/maplibre', replacement: path.resolve(__dirname, '../node_modules/react-map-gl/dist/esm/exports-maplibre.js') },
