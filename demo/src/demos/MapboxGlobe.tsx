...
/**
 * Mapbox GL globe projection demo with an HLS raster overlay.
 * Requires Mapbox GL JS v3+ (projection: 'globe').
 */
export default function MapboxGlobe({ hlsUrl, mapboxToken }: DemoProps) {
  return (
    <Map
      ...
      // @ts-ignore — projection is a valid Mapbox GL JS v3 option
      projection="globe"
    >
